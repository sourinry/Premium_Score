...
@Component({
  selector: 'app-old-matches-list',

  standalone: true,

  imports: [NgFor, NgIf, FormsModule],

  templateUrl: './old-matches-list.html',

  styleUrl: './old-matches-list.scss',
})
export class OldMatchesList implements OnInit {
  // =====================================================
  // SPORT
  // =====================================================
  ...
  loadMatches(): void {
    ...
    this.apiService.oldMatchListApi(payload).subscribe({
      next: (response: any) => {
  ...
  getMarketIds(match: any): string[] {
    ...
    return String(match.marketId).split('\n');
  }
